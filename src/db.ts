...
async function initDatabase(): Promise<void> {
    try {
        // Setup DB.
        await db.run('CREATE TABLE IF NOT EXISTS reactionroles (guild_id TEXT NOT NULL, msg_id TEXT NOT NULL, emoji TEXT NOT NULL, role_id TEXT NOT NULL, PRIMARY KEY (guild_id, msg_id, emoji))');
    }
    catch (e: any) {
